        ...
        <!-- Сроки строительства -->
            ...
            <section id="time" class="three something">
                <div class="container">

                    <header class="sub hd2">
                        <h1>Сроки строительства</h1>
                    </header>

                    <div class="box-info s3" style="margin-top: 3em">
                    <i class="icn fa-calendar fa"></i>
                    ...
                    <footer>
                        <a href="#cart" class="btn-go scrolly btn btn-3 round">
                            <i class="icn fa-angle-down fa i-1"></i>
                        </a>
